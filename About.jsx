        ...
        <section id="about" className="py-20 md:py-32 bg-slate-900/50">
            <div className="container">
                <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-center">
                    ...
                    >
                        <h4 className="text-primary font-bold tracking-widest uppercase text-[10px] md:text-sm mb-2 md:mb-4">The Visionaries</h4>
                        <h2 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 md:mb-8 font-heading">
                            Meet the <span className="text-gradient">Co-Founders</span>
                        </h2>
                        <p className="text-text-muted text-sm md:text-lg mb-6 md:mb-8 leading-relaxed">
                            <strong>Akash</strong> and <strong>Abishek Muthaiah</strong> are Pre-final year Computer Science & Engineering students at <strong>P.S.R. Engineering College</strong>.
                            Drag Innovation was born out of their shared passion for coding and design, aimed at bridging the gap between complex technology and elegant user experiences.
                        </p>
                        ...
                        <div className="space-y-4 md:space-y-6 text-left">
                            <div className="flex gap-4 p-4 glass-card rounded-xl">
                                ...
                                <div>
                                    <h5 className="font-bold text-white mb-1 text-sm md:text-base">Tech Scholars</h5>
                            ...
                            <div className="flex gap-4 p-4 glass-card rounded-xl">
                                ...
                                <div>
                                    <h5 className="font-bold text-white mb-1 text-sm md:text-base">Freelance Experts</h5>
